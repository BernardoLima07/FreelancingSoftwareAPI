...
export class ContractsService {
    ...
    async listContracts({ limit = 10, attributes = ['id', 'title', 'status', 'payment_amount'], whereType = {} }) {
        return this.contractsRepository.findAll({ limit: limit, attributes: attributes, whereType: whereType })
    }
    ...
    async update({ contractId, updatedData }) {
        return await this.contractsRepository.update({ contract_id: contractId, updatedData: updatedData })
    }
